...
export const ROUTE_META = {
  '/': {
    title: 'PDF Tools — Split, Merge & Compress PDFs Without Uploading',
    description:
  ...
  '/split': {
    title: 'Split PDF Offline — No Upload, No Account | PDF Tools',
    description:
  ...
  '/merge': {
    title: 'Merge PDF Without Uploading — Free & Private | PDF Tools',
    description:
  ...
  '/compress': {
    title: 'Compress PDF Without Upload — Honest Results | PDF Tools',
    description:
  ...
  '/reorder': {
    title: 'Reorder, Rotate & Delete PDF Pages Online — Private | PDF Tools',
    description:
  ...
  '/images-to-pdf': {
    title: 'Convert Images to PDF Offline — JPG & PNG | PDF Tools',
    description:
  ...
  '/privacy': {
    title: 'Privacy — Every Network Request, Documented | PDF Tools',
    description:
